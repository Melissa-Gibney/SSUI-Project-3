...
export class FSMInteractor {
    ...
    //. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
        ...
        // **** YOUR CODE HERE ****   
    private lastRegionsAffected: Region[] = [];
    private numAffectedRegions: number = 0;
    private enteredRegions: Region[] = [];
    private exitedRegions: Region[] = [];
                            ...
                            localX : number, localY : number) 
    {
        ...
        switch(what)
        {
            ...
            case 'move':
            {
                ...
                if(this.lastRegionsAffected !== affectedRegions)
                {
                    ...
                    let notExitedRegion: boolean = false;
                    ...
                    let notEnteredRegion: boolean = false;
        ...
        for(let i = 0; i < exitLoopLength; i++)
        {
            ...
            this.fsm?.actOnEvent('exit', curRegion);
        ...
        for(let i = 0; i < enterLoopLength; i++)
        {
            ...
            this.fsm?.actOnEvent('enter', curRegion);
